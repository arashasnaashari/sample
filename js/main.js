$(function () {
  ...
  handler.registerEvent("onEpubLoadSuccess", () => {
    ...
    current_theme =
      settings.theme == "author-theme" ? "default-theme" : settings.theme;
    isHorizontalScroll =
      settings.scroll == "auto" && settings.syntheticSpread == "auto";
  ...
  TreineticEpubReader.open("babak.epub");
